...
const ThankYouInvestmentReadinessChecklistPage = () => {
  const [isMobile, setIsMobile] = useState(false);

  useEffect(() => {
    document.title = 'Thank You | Investment Readiness Checklist';
                ...
                <div className="thanks_component">
                  <div className="thanks_content">
                    ...
                    >
                      ...
                      >
                        <a href="/documents/SuLe---Investment-Readiness-Guide.pdf" download="SuLe-Investment-Readiness-Guide.pdf" className="thanks_cta flex items-baseline gap-2 text-[#347AE9]">
                          {!isMobile && (
                             <div className="flex-shrink-0 w-5 h-5 flex items-center justify-center">
                               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true" role="img">
                                 <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" stroke="#347AE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  ...
                  <div className="investment_form-image-wrapper">
                    <img src="/lovable-uploads/dc28365e-8324-43bf-929f-9cbba95e2c30.png" loading="lazy" width="616" alt="Investment Readiness Checklist" className="investment_form-image" />
                  </div>
                </div>
              </div>
            </div>
...
export default ThankYouInvestmentReadinessChecklistPage;