...
const NewsPage = () => {
  ...
  useEffect(() => {
    document.title = 'News and Updates | SuLe Hub';
  }, []);
  ...
  // Sort news posts by date (newest to oldest)
            ...
            <div className="padding-section-large">
              <div className="container-large">
                <div className="margin-bottom margin-large">
                  ...
                  >
                    Stay informed with the latest company news, product updates, and announcements from SuLe Hub.
                  </p>
                </div>
