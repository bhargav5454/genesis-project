...
import PartnersSectionMobile from '@/components/homepage/PartnersSectionMobile';
            ...
            <div style={{
              ...
              <div style={{
                ...
                <h1 style={{
                  ...
                  A smart legal platform, built by expert lawyers
                </h1>
              ...
              <div style={{
                ...
                <img
                  src="/lovable-uploads/db6e8732-0d6a-4c17-ab50-a639d557a78c.png"
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                >
                  <source src="https://cdn.prod.website-files.com/647f1068e0d0c64b0785d563/673df7232c385f4cc7ff268f_360LegalCheck-transcode.mp4" type="video/mp4" />
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                Your complete legal toolkit in one place
              </h2> */}
              ...
              <p style={{
                ...
                Streamline your legal processes with our all-in-one Legal Wiki, designed specifically for tech companies and SMEs.
              </p>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <p style={{
                      ...
                      Get answers to your legal questions with actionable next steps tailored to your needs.
                    </p>
                  </div>
                </div>
        ...
        <section style={{
          ...
          <div className="container-large padding-global">
            ...
            <div style={{
              ...
              <div style={{
                display: 'grid',
                gridTemplateColumns: '12px 106px 123px 119px',
                gap: '0px',
                justifyContent: 'center',
                marginBottom: '0'
              }}>
                ...
                <div style={{
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    // className='button is-quaternary is-pricing w-button'
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
                      justifyContent: 'center',
